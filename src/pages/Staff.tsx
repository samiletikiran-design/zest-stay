    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">Manage your hostel team</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {loading ? (
                          ...
                          {(() => {
                            ...
                            return (
                              <span className={`text-[10px] px-2 py-0.5 rounded font-bold uppercase ${
                                status === 'paid' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600 animate-pulse'
                              }`}>
                                {label}
                              </span>
                            );
              ...
              <div className="col-span-full bg-white p-12 rounded-2xl border border-dashed border-gray-200 text-center text-gray-500">
                  ...
                  return (
                    <div key={salary.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between mb-1">
                        <p className="text-sm font-bold text-gray-900">{staffMember?.name || 'Unknown'}</p>
                        <p className="text-sm font-bold text-green-600">₹{salary.amount}</p>
                      </div>
                      <div className="flex items-center justify-between">
                        <p className="text-xs text-gray-500">{format(new Date(salary.date), 'MMM d, yyyy')}</p>
                        <p className="text-xs font-medium text-indigo-600 uppercase">{salary.month}</p>
                      </div>
                    </div>
                  );
                })
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl">
            <div className="p-6 text-center">
              ...
              <p className="text-gray-500 mb-6">This action cannot be undone. All records for this staff member will be removed.</p>
